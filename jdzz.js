...
const inviteCodes = ['AUWE5mvyQmDMKCTHx1HtNxg@AVnYD2PjC@Sv_52Rh4a813TIxmb1A@Sv_h6SBcY9VfeIR-b1A@St_hwRh8b_VzS@Sv_V0QBse_VPST0c', 'AVnYD2PjC@AUWE5mvyQmDMKCTHx1HtNxg@Sv_52Rh4a813TIxmb1A@Sv_h6SBcY9VfeIR-b1A@St_hwRh8b_VzS@Sv_V0QBse_VPST0c']
!(async () => {
  $.tuanList = []
  await requireConfig();
  if (helpAuthor) await getAuthorShareCode('https://raw.githubusercontent.com/msewebchen/self/master/jd_zz.json');
  if (helpAuthor) await getAuthorShareCode('https://raw.githubusercontent.com/msewebchen/self/master/jd_zz.json');
  if (!cookiesArr[0]) {

...
const inviteCodes = ['AUWE5mvyQmDMKCTHx1HtNxg@AVnYD2PjC@Sv_52Rh4a813TIxmb1A@Sv_h6SBcY9VfeIR-b1A@St_hwRh8b_VzS', 'AVnYD2PjC@AUWE5mvyQmDMKCTHx1HtNxg@Sv_52Rh4a813TIxmb1A@Sv_h6SBcY9VfeIR-b1A@St_hwRh8b_VzS']
!(async () => {
  $.tuanList = []
  await requireConfig();

...
const inviteCodes = ['T008474mB0tLCjVUnoaW5kRrbA', 'T0225KkcRU8ZoFLVIUv9nfANJwCjVUnoaW5kRrbA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
...
function jdhealth_collectScore(taskToken, taskId, itemId, actionType=0) {
  return new Promise(resolve => {
    let body = { "appId":"1EFRRxA","taskToken":taskToken,"taskId":taskId,"itemId":itemId,"actionType":actionType }

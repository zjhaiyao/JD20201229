...
$.newShareCodes = ['66aa6d4860888ab073261d9621dda802', 'd2e187997f9ccd6ac0f9091ac72bd75d'];
!(async () => {
  if (!cookiesArr[0]) {
  ...
  await getAuthorShareCode('https://raw.githubusercontent.com/msewebchen/self/master/jd_jdh.json');
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      cookie = cookiesArr[i];
      await helpFriends()
